...
import static com.ducdungdam.bakingapp.widgets.AppWidget.IngredientsRemoteViewsFactory.EXTRA_RECIPE;
        ...
        public void onChanged(@Nullable List<Recipe> recipes) {
          if (recipes != null) {
            if (rootView.rvRecipeList.getAdapter() == null) {
              RecipeWidgetConfigurationAdapter adapter = new RecipeWidgetConfigurationAdapter(recipes);
